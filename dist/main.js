...
/* harmony import */ var _weather__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weather */ "./lib/weather.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#city-input').select2();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#city-input').select2({ data: cities, width: '50%' }); // <-- add the `data` and `width` options
...
search.addEventListener('submit', (event) => {
  event.preventDefault();
  Object(_weather__WEBPACK_IMPORTED_MODULE_2__["searchWeather"])(cityInput.value);
});
...
/*!************************!*\
  !*** ./lib/weather.js ***!
  \************************/
/*! exports provided: currentWeather, searchWeather, displayData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
